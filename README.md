...
- 🌐 **Page fetch:** same-origin Promise-based `fetch()` supports common HTTP methods, string or string-field `FormData` bodies, and JSON/text responses.
